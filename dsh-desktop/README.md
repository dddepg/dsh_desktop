...
│   └── plugins/          # dsh-balance / dsh-file-changes / dsh-gitgraph / dsh-vision / zat-dsh-engine / dsh-better-sidebar / dsh-navbar / dsh-super-injector / dsh-wsl-settings（设置页「WSL 后端」栏）等，启动时自动同步进 web profile
├── scripts/
