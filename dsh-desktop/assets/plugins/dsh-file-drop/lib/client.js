...
(function () {
  ...
  var ATTACH_CSS = [
    ...
    'font-size:12px;line-height:16px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-primary-fill,#f2f2f4);',
    'border:1px solid var(--dsw-alias-border-l2,#e2e2e6);border-radius:8px;overflow:hidden;}',
    '.dsh-file-drop-chip--path{background:var(--dsw-alias-state-warn-tertiary,#fff6e6);border-color:var(--dsw-alias-state-warn-primary,#e0a63c);}',
