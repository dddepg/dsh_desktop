  ...
  factory: (require) => {
    ...
    if (typeof document !== "undefined" && document.querySelector('style[data-plugin-css="' + CSS_ID + '"]') === null) {
      ...
      tag.textContent = [
        ...
        ".dspg_modal{width:min(440px,calc(100vw - 32px));max-height:calc(100vh - 64px);overflow:auto;background:var(--dsw-alias-bg-base,#202127);color:var(--dsw-alias-label-primary,#e8e8ea);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.12));border-radius:14px;box-shadow:0 16px 48px rgba(0,0,0,.5);padding:18px 20px;box-sizing:border-box}",
        ...
        ".dspg_blocked{font-size:12px;color:var(--dsw-alias-state-warn-primary,#f2b24c);background:rgba(242,178,76,.12);border:1px solid rgba(242,178,76,.3);border-radius:8px;padding:6px 10px;margin-bottom:10px}",
        ...
        ".dspg_table th,.dspg_table td{text-align:left;padding:4px 8px;border-bottom:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.08))}",
        ".dspg_table th{color:var(--dsw-alias-label-tertiary,#9a9aa2);font-weight:500}",
        ".dspg_peak{color:var(--dsw-alias-state-warn-primary,#f2b24c);font-weight:600}",
        ".dspg_off{color:var(--dsw-alias-label-tertiary,#9a9aa2)}",
        ".dspg_cmd{background:rgba(255,255,255,.05);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.1));border-radius:8px;padding:8px 10px;font-size:12px;color:var(--dsw-alias-label-secondary,#b6b6bd);margin-bottom:10px;max-height:96px;overflow:auto;white-space:pre-wrap;word-break:break-all}",
        ...
        ".dspg_btn{flex:1;min-width:120px;padding:8px 14px;border-radius:9px;border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.14));background:rgba(255,255,255,.06);color:var(--dsw-alias-label-primary,#e8e8ea);font-size:13px;cursor:pointer;font-family:inherit}",
        ".dspg_btn:hover{background:rgba(255,255,255,.12)}",
        ".dspg_btn_primary{background:var(--dsw-alias-brand-primary,#4c8dff);border-color:transparent;color:#fff}",
        ".dspg_btn_primary:hover{background:var(--dsw-alias-button-primary-hover,#3d7bef)}",
        ...
        ".dspg_check input{accent-color:var(--dsw-alias-brand-primary,#4c8dff)}",
        ...
        ".dspg_wheel_list{height:150px;overflow-y:auto;scrollbar-width:none;border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.1));border-radius:9px;background:rgba(0,0,0,.18);padding:4px 0;width:96px;text-align:center}",
        ...
        ".dspg_wheel_item_sel{background:var(--dsw-alias-brand-primary,#4c8dff);color:#fff;font-weight:600}",
